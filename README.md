...
[![version](https://img.shields.io/badge/version-v0.0.0.9008-orange)](https://github.com/OxfordIHTM/computer-vision-demo/releases/tag/v0.0.0.9008)
[![License for
...
graph LR
  ...
  subgraph Graph
    ...
    xec2d391ea0f39691(["text_extraction_handwriting_report"]):::completed
  end
```
